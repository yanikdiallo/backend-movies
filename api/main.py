...
# initialisationn de  l'application FastAPI
...
# un endpoint pour tester la sante de l'API
@app.get(
    "/",
    summary="Test de l'API",
    description="Un endpoint pour tester la santé de l'API.",
    response_description=" Status de l'API",
    operation_id="health_check movies_api",
    tags=["Monitoring"],
...
async def root():
    return {"message": "L'API MovieLens est opérationnelle !"}
